...
class Elf:
    ...
    #     if not (dyn_editor := DynamicEntryEditor(self)):
    #         return False
    ...
    #     ph_editor = ProgramHeaderEditor(self)
    #     # elfhdr_editor = self.get_editor(EDITOR.ELF_HEADER)
    #     elfhdr_editor = ElfHeaderEditor(self)
    ...
    #             sh_editor = SectionHeaderEditor(self)
    ...
    #     elfh_editor = ElfHeaderEditor(self)
    ...
    #     # sh_editor: SectionHeaderEditor = self.get_editor(EDITOR.SECTION_HEADER)
    #     st_editor = SymbolEditor(self, SECTION.DYNSYM)
    #     sh_editor = SectionHeaderEditor(self)
